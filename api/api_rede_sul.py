"""
API de rastreamento para Rede Sul Logística.
"""
import re
import logging
import requests
...
class RedesulTransportadora(BaseTransportadora):
    """Implementação para Rede Sul Logística"""

    def __init__(self):
        super().__init__(nome="COOPERATIVA")
    ...
    def consultar_por_cpf(self, cpf: str) -> str:
        ...
        headers = {
            ...
            "Origin": "http://www.redesullog.com.br",
            "Referer": "http://www.redesullog.com.br/",
        }

        payload = {
            "urlori": "http://www.redesullog.com.br",
            "sigla_emp": "RED",
            "cnpjdest": cpf_limpo
        }

        try:
            logger.info(f"Consultando Rede Sul com CPF: {cpf_limpo}")
            ...
            logger.info("Dados da Rede Sul obtidos com sucesso")
            return resp_detalhado.text

        except Exception as e:
            logger.error(f"Erro ao consultar Rede Sul: {str(e)}")
            return ""
    ...
    def formatar_rastreamento(self, pedido: dict) -> str:
        ...
        mensagem = f"📦 *RASTREAMENTO - REDE SUL LOGÍSTICA*\n\n"
